...
@Tag(name = "Notification", description = "알림 생성/조회/읽음/삭제/Pull")
public class NotificationRestController {
                                        ...
                                        "notifications": [
                                          {
                                            ...
                                            "isDelivered": true,
                                            "readAt": null,
                                            "deliveredAt": "2025-09-24T10:10:00"
                                          }
                                        ]
                                      }
                                    }
    ...
    @Operation(
            ...
            description = """
                ...
                - 예: /api/notifications?type=BUDGET&page=0&size=20
                """,
                                        ...
                                        "content": [
                                          {
                                            ...
                                            "title": "예산 초과 알림",
                                            "body": "카페/간식 예산을 초과했습니다.",
                                            "type": "BUDGET",
                                            "isRead": false,
                                            "isDelivered": true,
                                            "readAt": null,
                                            "deliveredAt": "2025-09-20T15:00:03"
                                          }
                                        ],
                                        "page": 0,
                                        "size": 20,
                                        ...
                                        "content": [
                                          {
                                            ...
                                            "title": "새 혜택 알림",
                                            "body": "이번 달 구독비 혜택이 추가되었습니다.",
                                            "type": "MARKETING",
                                            "isRead": false,
                                            "isDelivered": true,
                                            "readAt": null,
                                            "deliveredAt": "2025-09-21T09:10:00"
                                          }
                                        ],
                                        "page": 0,
                                        "size": 20,
    ...
    @Operation(
            ...
            description = "현재 계정의 읽지 않은 알림 개수를 반환합니다.",
