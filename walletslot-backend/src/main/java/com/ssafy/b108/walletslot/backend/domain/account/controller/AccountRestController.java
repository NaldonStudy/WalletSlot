...
public class AccountRestController {
    ...
    public ResponseEntity<RequestVerificationResponseDto> requestVerification(@RequestBody RequestVerificationRequestDto requestVerificationRequestDto) {
        return ResponseEntity.status(HttpStatus.CREATED).body(accountService.requestVerification(1L, requestVerificationRequestDto.getAccountNo()));
    }
}
