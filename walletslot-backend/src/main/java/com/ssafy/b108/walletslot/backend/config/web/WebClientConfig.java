...
public class WebClientConfig {
    ...
    @Bean
    public WebClient ssafyGmsWebClient(
            @Value("${api.ssafy.gms.key}") String ssafyGmsKey,
            @Value("${api.ssafy.gms.baseUrl}") String ssafyGmsBaseUrl) {
        return WebClient.builder()
                .baseUrl(ssafyGmsBaseUrl) // <<여기에는 SSAFY GMS Base URL 정보>>
